<template>
  <div class="essay-brief" @click="toTalkDetail(essayItemData._id)">
    ...
    <div class="essay-right">
      ...
      <div class="essay-right-footer clear-fix">
        ...
        <span class="user-name-text" @click.stop="onclickName(essayItemData.anglerId)">{{essayItemData.anglerName}}</span>
...
export default {
  ...
  methods:{
    ...
    onclickName(anglerId){
      // console.log(anglerId);
       this.$emit("clickNameFn",anglerId);
    }
  }
};
</script>
